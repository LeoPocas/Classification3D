...
def load_incor_data(training = True, data_dir=INCOR_RESAMPLED_PATH, csv_path=CSV_PATH, target_shape=TARGET_SHAPE, label_mapping=LABEL_MAPPING_MMS, zoom_factor=ZOOM):
    volumes = []
    labels = []
