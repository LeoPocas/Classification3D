...
import numpy as np
import gc
from Classification3D.models.classification.models import cnn_3d_model, build_med3d, newModel, dualInput_Resnet
...
x_train_img, x_val_img, y_train, y_val, x_train_meta, x_val_meta = train_test_split(
    images, labels, patient_data, test_size=0.2, random_state=35
)
